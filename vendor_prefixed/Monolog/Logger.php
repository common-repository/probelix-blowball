...
namespace PbxVendor\Monolog;

use DateTimeZone;
use PbxVendor\Monolog\Handler\HandlerInterface;
use PbxVendor\Psr\Log\LoggerInterface;
use PbxVendor\Psr\Log\InvalidArgumentException;
use PbxVendor\Psr\Log\LogLevel;
use Throwable;
use Stringable;

/**
 * PbxVendor\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     * there is no performance penalty and PbxVendor\Monolog 2 enabled microseconds
     ...
     *
     * @throws \PbxVendor\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
    ...
    /**
     * Converts PSR-3 levels to PbxVendor\Monolog ones if necessary
     *
