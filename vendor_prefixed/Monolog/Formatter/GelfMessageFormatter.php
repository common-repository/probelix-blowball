...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string a prefix for 'extra' fields from the PbxVendor\Monolog record (optional)
     */
    protected $extraPrefix;

    /**
     * @var string a prefix for 'context' fields from the PbxVendor\Monolog record (optional)
     */
    ...
    /**
     * Translates PbxVendor\Monolog log levels to Graylog2 log priorities.
     *
     * @var array<int, int>
     *
