...
use PbxVendor\Monolog\Formatter\LineFormatter;
use PbxVendor\Monolog\Formatter\FormatterInterface;
use PbxVendor\Monolog\Logger;
use PbxVendor\Monolog\Utils;
use PhpConsole\Connector;
use PhpConsole\Handler as VendorPhpConsoleHandler;
use PhpConsole\Helper;

/**
 * PbxVendor\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \PbxVendor\Monolog\Logger('all', array(new \PbxVendor\Monolog\Handler\PHPConsoleHandler()));
 *      \PbxVendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['PbxVendor\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \PbxVendor\Monolog\Handler\PHPConsoleHandler::$options for more details
